<template>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><strong>EDITAR PRODUCTO</strong></h1>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input
                                                        ...
                                                        class="form-control"
                                                        v-model="
                                                            fillEditarProducto.cDescripcion
                                                        "
                                                        @:keyup.enter="
                                                            setEditarProducto
                                                        "
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <el-select
                                                        v-model="
                                                            fillEditarProducto.nIdCategoria
                                                        "
